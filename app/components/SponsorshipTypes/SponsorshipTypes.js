import styles from "@/app/components/SponsorshipTypes/SponsorshipTypes.module.css";
  ...
  return (
    <section id="membership" className={`${styles.section} grid-component`}>
      ...
      <p className={styles.text2}>
        We deeply appreciate the support of our sponsors, who play a crucial
        role in helping us achieve our goals. Discover the various opportunities
        available for sponsorship and learn more about how you can contribute to
        our mission. Feel free to contact us for more information.
      </p>
      ...
      <div className={styles.membership}>
        ...
        <div className={styles.cardMiddle}>
          ...
          <Link href="#footer" className={styles.linkMiddle}>
            CONTACT
          </Link>
        </div>
        <div className={styles.card}>
